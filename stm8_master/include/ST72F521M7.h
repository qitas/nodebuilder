...
#ifndef __ST72F521M7__
#define __ST72F521M7__
...
/* ST72F521M7 */
	...
	#ifdef MCU_NAME
		#define ST72F521M7 1
		#if (MCU_NAME != ST72F521M7)
		#error "wrong include file ST72F521M7.h for chosen MCU!"
		#endif
	#endif
...
/* Data Register */
DEF_8BIT_REG_AT(PGDR,0x12);

/* Data Direction Register */
DEF_8BIT_REG_AT(PGDDR,0x13);

/* Option Register */
DEF_8BIT_REG_AT(PGOR,0x14);

/* Port H */
/*****************************************************************/

/* Data Register */
DEF_8BIT_REG_AT(PHDR,0x15);

/* Data Direction Register */
DEF_8BIT_REG_AT(PHDDR,0x16);

/* Option Register */
DEF_8BIT_REG_AT(PHOR,0x17);
