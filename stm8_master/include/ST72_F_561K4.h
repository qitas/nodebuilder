...
#ifndef __ST72_F_561K4__
#define __ST72_F_561K4__

/* ST72(F)561K4 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST72_F_561K4 1
		#if (MCU_NAME != ST72_F_561K4)
		#error "wrong include file ST72_F_561K4.h for chosen MCU!"
		#endif
	#endif
