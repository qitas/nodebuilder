...
#ifndef __ST72_F_561K9__
#define __ST72_F_561K9__

/* ST72(F)561K9 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST72_F_561K9 1
		#if (MCU_NAME != ST72_F_561K9)
		#error "wrong include file ST72_F_561K9.h for chosen MCU!"
		#endif
	#endif
