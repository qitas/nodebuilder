...
/* ST7FDALI */
	...
	#ifdef MCU_NAME
		#define ST7FDALI 1
		#if (MCU_NAME != ST7FDALI)
		#error "wrong include file ST7FDALI.h for chosen MCU!"
		#endif
	#endif
...
/* Clock Register */
DEF_8BIT_REG_AT(DCMCLK,0x40);

/* Forward Address Register */
DEF_8BIT_REG_AT(DCMFA,0x41);

/* Forward Data Register */
DEF_8BIT_REG_AT(DCMFD,0x42);

/* Backward Data Register */
DEF_8BIT_REG_AT(DCMBD,0x43);

/* Control Register */
DEF_8BIT_REG_AT(DCMCR,0x44);
#define DCMCR_FTS	0		/* Force Transmit State */
#define DCMCR_FTS_OR	(1 << DCMCR_FTS)
#define DCMCR_RTS	1		/* Receive/Transmit State */
#define DCMCR_RTS_OR	(1 << DCMCR_RTS)
#define DCMCR_RTA	2		/* Receive/Transmit Acknowledge */
#define DCMCR_RTA_OR	(1 << DCMCR_RTA)
#define DCMCR_DCME	3		/* DALI Communication Enable */
#define DCMCR_DCME_OR	(1 << DCMCR_DCME)

/* Control/Status Register */
DEF_8BIT_REG_AT(DCMCSR,0x45);
