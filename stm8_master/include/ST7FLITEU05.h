...
#ifndef __ST7FLITEU05__
#define __ST7FLITEU05__

/* ST7FLITEU05 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7FLITEU05 1
		#if (MCU_NAME != ST7FLITEU05)
		#error "wrong include file ST7FLITEU05.h for chosen MCU!"
		#endif
	#endif
