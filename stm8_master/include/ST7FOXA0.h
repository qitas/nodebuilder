...
/* ST7FOXA0 */
	...
	#ifdef MCU_NAME
		#define ST7FOXA0 1
		#if (MCU_NAME != ST7FOXA0)
		#error "wrong include file ST7FOXA0.h for chosen MCU!"
		#endif
	#endif
