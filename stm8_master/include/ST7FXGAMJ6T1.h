...
#ifndef __ST7FXGAMJ6T1__
#define __ST7FXGAMJ6T1__

/* ST7FXGAMJ6T1 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7FXGAMJ6T1 1
		#if (MCU_NAME != ST7FXGAMJ6T1)
		#error "wrong include file ST7FXGAMJ6T1.h for chosen MCU!"
		#endif
	#endif
