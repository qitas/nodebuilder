...
#ifndef __STM8S903K__
#define __STM8S903K__
...
/* STM8S903K */
	...
	#ifdef MCU_NAME
		#define STM8S903K 1
		#if (MCU_NAME != STM8S903K)
		#error "wrong include file STM8S903K.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(TIM5_IER,0x5303);

/* TIM5 Status register 1 */
DEF_8BIT_REG_AT(TIM5_SR1,0x5304);

/* TIM5 Status register 2 */
DEF_8BIT_REG_AT(TIM5_SR2,0x5305);

/* TIM5 Event Generation register */
DEF_8BIT_REG_AT(TIM5_EGR,0x5306);

/* TIM5 Capture/Compare mode register 1 */
DEF_8BIT_REG_AT(TIM5_CCMR1,0x5307);

/* TIM5 Capture/Compare mode register 2 */
DEF_8BIT_REG_AT(TIM5_CCMR2,0x5308);

/* TIM5 Capture/Compare mode register 3 */
DEF_8BIT_REG_AT(TIM5_CCMR3,0x5309);

/* TIM5 Capture/Compare enable register 1 */
DEF_8BIT_REG_AT(TIM5_CCER1,0x530a);

/* TIM5 Capture/Compare enable register 2 */
DEF_8BIT_REG_AT(TIM5_CCER2,0x530b);
...
DEF_16BIT_REG_AT(TIM5_CCR3,0x5315);
/* Data bits High */
DEF_8BIT_REG_AT(TIM5_CCR3H,0x5315);
/* Data bits Low */
DEF_8BIT_REG_AT(TIM5_CCR3L,0x5316);

/* 8-Bit  Timer 6 (TIM6) */
/*****************************************************************/

/* TIM6 Control register 1 */
DEF_8BIT_REG_AT(TIM6_CR1,0x5340);

/* TIM6 Control register 2 */
DEF_8BIT_REG_AT(TIM6_CR2,0x5341);

/* TIM6 Slave Mode Control register */
DEF_8BIT_REG_AT(TIM6_SMCR,0x5342);

/* TIM6 Interrupt enable register */
DEF_8BIT_REG_AT(TIM6_IER,0x5343);

/* TIM6 Status register */
DEF_8BIT_REG_AT(TIM6_SR,0x5344);

/* TIM6 Event Generation register */
DEF_8BIT_REG_AT(TIM6_EGR,0x5345);

/* TIM6 Counter */
DEF_8BIT_REG_AT(TIM6_CNTR,0x5346);

/* TIM6 Prescaler register */
DEF_8BIT_REG_AT(TIM6_PSCR,0x5347);

/* TIM6 Auto-reload register */
DEF_8BIT_REG_AT(TIM6_ARR,0x5348);
