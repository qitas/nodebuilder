...
/* ST72345 */
	...
	/* Check MCU name */
		...
		#define ST72345 1
		#if (MCU_NAME != ST72345)
		#error "wrong include file ST72345.h for chosen MCU!"
		#endif
	#endif
...
/* RCC Control High Register */
DEF_8BIT_REG_AT(RCCRH,0x17);

/* RCC Control Low Register */
DEF_8BIT_REG_AT(RCCRL,0x18);
#define RCCRL_ADD0	0		/* Frequency Adjustment */
#define RCCRL_ADD0_OR	(1 << RCCRL_ADD0)
#define RCCRL_ADD1	1		/* Frequency Adjustment */
#define RCCRL_ADD1_OR	(1 << RCCRL_ADD1)
#define RCCRL_ADD_OR	((1 << RCCRL_ADD0)|(1 << RCCRL_ADD1))
...
/* I2C Triple Slave Interface with DMA (I2C3SNS) */
/*****************************************************************/

/* Control Register 1 */
DEF_8BIT_REG_AT(I2C3SCR1,0x60);
#define I2C3SCR1_ITWE1_2	0		/* Interrupt on Write */
#define I2C3SCR1_ITWE1_2_OR	(1 << I2C3SCR1_ITWE1_2)
#define I2C3SCR1_ITWE3	1		/* Interrupt on Write */
#define I2C3SCR1_ITWE3_OR	(1 << I2C3SCR1_ITWE3)
#define I2C3SCR1_ITRE1_2	2		/* Interrupt on Read */
#define I2C3SCR1_ITRE1_2_OR	(1 << I2C3SCR1_ITRE1_2)
#define I2C3SCR1_ITRE3	3		/* Interrupt on Read */
#define I2C3SCR1_ITRE3_OR	(1 << I2C3SCR1_ITRE3)
#define I2C3SCR1_ITER	4		/* Interrupt NACK */
#define I2C3SCR1_ITER_OR	(1 << I2C3SCR1_ITER)
#define I2C3SCR1_PL0	6		/* Page Lenght */
#define I2C3SCR1_PL0_OR	(1 << I2C3SCR1_PL0)
#define I2C3SCR1_PL1	7		/* Page Lenght */
#define I2C3SCR1_PL1_OR	(1 << I2C3SCR1_PL1)
#define I2C3SCR1_PL_OR	((1 << I2C3SCR1_PL0)|(1 << I2C3SCR1_PL1))

/* Control Register 2 */
DEF_8BIT_REG_AT(I2C3sCR2,0x61);
#define I2C3sCR2_B_W	0		/* Byte/Word Mode */
#define I2C3sCR2_B_W_OR	(1 << I2C3sCR2_B_W)
#define I2C3sCR2_BusyW	1		/* Busy on Write */
#define I2C3sCR2_BusyW_OR	(1 << I2C3sCR2_BusyW)
#define I2C3sCR2_PE	2		/* Peripheral I2C */
#define I2C3sCR2_PE_OR	(1 << I2C3sCR2_PE)
#define I2C3sCR2_WP1	3		/* Write Protect 1 */
#define I2C3sCR2_WP1_OR	(1 << I2C3sCR2_WP1)
#define I2C3sCR2_WP2	4		/* Write Protect 2 */
#define I2C3sCR2_WP2_OR	(1 << I2C3sCR2_WP2)

/* Status Register */
DEF_8BIT_REG_AT(I2C3SSR,0x62);
#define I2C3SSR_RF1	0		/* Read Slave 1 */
#define I2C3SSR_RF1_OR	(1 << I2C3SSR_RF1)
#define I2C3SSR_RF2	1		/* Read Slave 2 */
#define I2C3SSR_RF2_OR	(1 << I2C3SSR_RF2)
#define I2C3SSR_RF3	2		/* Read Slave 3 */
#define I2C3SSR_RF3_OR	(1 << I2C3SSR_RF3)
#define I2C3SSR_WF1	3		/* Write Slave 1 */
#define I2C3SSR_WF1_OR	(1 << I2C3SSR_WF1)
#define I2C3SSR_WF2	4		/* Write Slave 2 */
#define I2C3SSR_WF2_OR	(1 << I2C3SSR_WF2)
#define I2C3SSR_WF3	5		/* Write Slave 3 */
#define I2C3SSR_WF3_OR	(1 << I2C3SSR_WF3)
#define I2C3SSR_BERR	6		/* Bus Error */
#define I2C3SSR_BERR_OR	(1 << I2C3SSR_BERR)
#define I2C3SSR_NACK	7		/* Non Acknoledge */
#define I2C3SSR_NACK_OR	(1 << I2C3SSR_NACK)

/* Byte Count Register */
DEF_8BIT_REG_AT(I2C3SBCR,0x63);

/* Slave Address Register 1 */
DEF_8BIT_REG_AT(I2C3SSAR1,0x64);
#define I2C3SSAR1_EN1	0		/* Enable Bit */
#define I2C3SSAR1_EN1_OR	(1 << I2C3SSAR1_EN1)
#define I2C3SSAR1_ADD1	1		/* Slave Address 1 */
#define I2C3SSAR1_ADD1_OR	(1 << I2C3SSAR1_ADD1)
#define I2C3SSAR1_ADD2	2		/* Slave Address 1 */
#define I2C3SSAR1_ADD2_OR	(1 << I2C3SSAR1_ADD2)
#define I2C3SSAR1_ADD3	3		/* Slave Address 1 */
#define I2C3SSAR1_ADD3_OR	(1 << I2C3SSAR1_ADD3)
#define I2C3SSAR1_ADD4	4		/* Slave Address 1 */
#define I2C3SSAR1_ADD4_OR	(1 << I2C3SSAR1_ADD4)
#define I2C3SSAR1_ADD5	5		/* Slave Address 1 */
#define I2C3SSAR1_ADD5_OR	(1 << I2C3SSAR1_ADD5)
#define I2C3SSAR1_ADD6	6		/* Slave Address 1 */
#define I2C3SSAR1_ADD6_OR	(1 << I2C3SSAR1_ADD6)
#define I2C3SSAR1_ADD7	7		/* Slave Address 1 */
#define I2C3SSAR1_ADD7_OR	(1 << I2C3SSAR1_ADD7)
#define I2C3SSAR1_ADD_OR	((1 << I2C3SSAR1_ADD1)|(1 << I2C3SSAR1_ADD2)\
		|(1 << I2C3SSAR1_ADD3)|(1 << I2C3SSAR1_ADD4)\
		|(1 << I2C3SSAR1_ADD5)|(1 << I2C3SSAR1_ADD6)|(1 << I2C3SSAR1_ADD7))

/* Current Address Register 1 */
DEF_8BIT_REG_AT(I2C3SCAR1,0x65);

/* Slave Address Register 2 */
DEF_8BIT_REG_AT(I2C3SSAR2,0x66);
#define I2C3SSAR2_EN2	0		/* Enable Bit */
#define I2C3SSAR2_EN2_OR	(1 << I2C3SSAR2_EN2)
#define I2C3SSAR2_ADD1	1		/* Slave Address 2 */
#define I2C3SSAR2_ADD1_OR	(1 << I2C3SSAR2_ADD1)
#define I2C3SSAR2_ADD2	2		/* Slave Address 2 */
#define I2C3SSAR2_ADD2_OR	(1 << I2C3SSAR2_ADD2)
#define I2C3SSAR2_ADD3	3		/* Slave Address 2 */
#define I2C3SSAR2_ADD3_OR	(1 << I2C3SSAR2_ADD3)
#define I2C3SSAR2_ADD4	4		/* Slave Address 2 */
#define I2C3SSAR2_ADD4_OR	(1 << I2C3SSAR2_ADD4)
#define I2C3SSAR2_ADD5	5		/* Slave Address 2 */
#define I2C3SSAR2_ADD5_OR	(1 << I2C3SSAR2_ADD5)
#define I2C3SSAR2_ADD6	6		/* Slave Address 2 */
#define I2C3SSAR2_ADD6_OR	(1 << I2C3SSAR2_ADD6)
#define I2C3SSAR2_ADD7	7		/* Slave Address 2 */
#define I2C3SSAR2_ADD7_OR	(1 << I2C3SSAR2_ADD7)
#define I2C3SSAR2_ADD_OR	((1 << I2C3SSAR2_ADD1)|(1 << I2C3SSAR2_ADD2)\
		|(1 << I2C3SSAR2_ADD3)|(1 << I2C3SSAR2_ADD4)\
		|(1 << I2C3SSAR2_ADD5)|(1 << I2C3SSAR2_ADD6)|(1 << I2C3SSAR2_ADD7))

/* Current Address Register 2 */
DEF_8BIT_REG_AT(I2C3SCAR2,0x67);

/* Slave Address Register 3 */
DEF_8BIT_REG_AT(I2C3SSAR3,0x68);
#define I2C3SSAR3_EN3	0		/* Enable Bit */
#define I2C3SSAR3_EN3_OR	(1 << I2C3SSAR3_EN3)
#define I2C3SSAR3_ADD1	1		/* Slave Address 3 */
#define I2C3SSAR3_ADD1_OR	(1 << I2C3SSAR3_ADD1)
#define I2C3SSAR3_ADD2	2		/* Slave Address 3 */
#define I2C3SSAR3_ADD2_OR	(1 << I2C3SSAR3_ADD2)
#define I2C3SSAR3_ADD3	3		/* Slave Address 3 */
#define I2C3SSAR3_ADD3_OR	(1 << I2C3SSAR3_ADD3)
#define I2C3SSAR3_ADD4	4		/* Slave Address 3 */
#define I2C3SSAR3_ADD4_OR	(1 << I2C3SSAR3_ADD4)
#define I2C3SSAR3_ADD5	5		/* Slave Address 3 */
#define I2C3SSAR3_ADD5_OR	(1 << I2C3SSAR3_ADD5)
#define I2C3SSAR3_ADD6	6		/* Slave Address 3 */
#define I2C3SSAR3_ADD6_OR	(1 << I2C3SSAR3_ADD6)
#define I2C3SSAR3_ADD7	7		/* Slave Address 3 */
#define I2C3SSAR3_ADD7_OR	(1 << I2C3SSAR3_ADD7)
#define I2C3SSAR3_ADD_OR	((1 << I2C3SSAR3_ADD1)|(1 << I2C3SSAR3_ADD2)\
		|(1 << I2C3SSAR3_ADD3)|(1 << I2C3SSAR3_ADD4)\
		|(1 << I2C3SSAR3_ADD5)|(1 << I2C3SSAR3_ADD6)|(1 << I2C3SSAR3_ADD7))

/* Current Address Register 3 */
DEF_8BIT_REG_AT(I2C3SCAR3,0x69);
