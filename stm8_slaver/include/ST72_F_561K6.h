...
#ifndef __ST72_F_561K6__
#define __ST72_F_561K6__

/* ST72(F)561K6 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST72_F_561K6 1
		#if (MCU_NAME != ST72_F_561K6)
		#error "wrong include file ST72_F_561K6.h for chosen MCU!"
		#endif
	#endif
