...
#ifndef __ST72_F_561_A_R4__
#define __ST72_F_561_A_R4__

/* ST72(F)561(A)R4 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST72_F_561_A_R4 1
		#if (MCU_NAME != ST72_F_561_A_R4)
		#error "wrong include file ST72_F_561_A_R4.h for chosen MCU!"
		#endif
	#endif
