...
#ifndef __ST7FLITEU02__
#define __ST7FLITEU02__

/* ST7FLITEU02 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7FLITEU02 1
		#if (MCU_NAME != ST7FLITEU02)
		#error "wrong include file ST7FLITEU02.h for chosen MCU!"
		#endif
	#endif
