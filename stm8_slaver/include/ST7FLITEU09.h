...
#ifndef __ST7FLITEU09__
#define __ST7FLITEU09__

/* ST7FLITEU09 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7FLITEU09 1
		#if (MCU_NAME != ST7FLITEU09)
		#error "wrong include file ST7FLITEU09.h for chosen MCU!"
		#endif
	#endif
