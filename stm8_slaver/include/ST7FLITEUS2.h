...
#ifndef __ST7FLITEUS2__
#define __ST7FLITEUS2__

/* ST7FLITEUS2 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7FLITEUS2 1
		#if (MCU_NAME != ST7FLITEUS2)
		#error "wrong include file ST7FLITEUS2.h for chosen MCU!"
		#endif
	#endif
