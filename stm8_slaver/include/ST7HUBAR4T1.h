...
#ifndef __ST7HUBAR4T1__
#define __ST7HUBAR4T1__

/* ST7HUBAR4T1 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define ST7HUBAR4T1 1
		#if (MCU_NAME != ST7HUBAR4T1)
		#error "wrong include file ST7HUBAR4T1.h for chosen MCU!"
		#endif
	#endif
