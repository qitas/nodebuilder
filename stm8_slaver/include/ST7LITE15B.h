...
#ifndef __ST7LITE15B__
#define __ST7LITE15B__
...
/* ST7LITE15B */
	...
	#ifdef MCU_NAME
		#define ST7LITE15B 1
		#if (MCU_NAME != ST7LITE15B)
		#error "wrong include file ST7LITE15B.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(VREFCR,0x2c);

/* Comparator and Internal Reference Control Register */
DEF_8BIT_REG_AT(CMPCR,0x2d);
